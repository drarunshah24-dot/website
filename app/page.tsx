...
import { Phone, ArrowRight, ShieldCheck, Clock, Award, Droplets, HeartPulse, UserRound, BookOpen, Camera } from "lucide-react";
            ...
            <div className="flex flex-col justify-center space-y-8 max-w-2xl">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold tracking-tight text-slate-900 leading-[1.1]">
                  World-Class Urology Care in <span className="text-primary">Janakpur</span>
                </h1>
                <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
                  Advanced laser surgery and compassionate treatment by <span className="font-semibold text-slate-800">Dr. Arun Shah</span>. Experience premium healthcare with modern technology.
                </p>
              </div>
              ...
              <div className="mt-8 flex items-center gap-4 bg-white p-4 rounded-2xl shadow-md border border-slate-100 w-fit">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-slate-500">Patients Treated</div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">Advanced Urological Treatments</h2>
              <p className="text-lg text-slate-600">We provide state-of-the-art diagnostic and surgical solutions for all urological conditions using minimally invasive techniques.</p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/conditions/kidney-stones" className="block h-full">
              <Card className="h-full border-slate-100 shadow-sm transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl hover:border-blue-200 group cursor-pointer">
                <CardHeader>
                  ...
                  <CardDescription className="text-base pt-2">Advanced laser surgery for kidney stones without large incisions, ensuring faster recovery.</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Link href="/conditions/prostate-enlargement" className="block h-full">
              <Card className="h-full border-slate-100 shadow-sm transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl hover:border-blue-200 group cursor-pointer">
                <CardHeader>
                  ...
                  <CardDescription className="text-base pt-2">Minimally invasive laser treatments (HoLEP/TURP) for enlarged prostate and urinary issues.</CardDescription>
                </CardHeader>
                <CardContent>
                  <span className="text-primary font-medium flex items-center gap-2 group-hover:underline">
                    Learn more <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            ...
            <Link href="/conditions/male-sexual-health" className="block h-full">
              <Card className="h-full border-slate-100 shadow-sm transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl hover:border-blue-200 group cursor-pointer">
                <CardHeader>
                  ...
                  <CardDescription className="text-base pt-2">Confidential and expert care for erectile dysfunction, male infertility, and related conditions.</CardDescription>
                </CardHeader>
                <CardContent>
                  <span className="text-primary font-medium flex items-center gap-2 group-hover:underline">
                    Learn more <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
        ...
        <section className="py-20 bg-slate-50 border-y border-slate-200">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">Publications by Dr. Arun Shah</h2>
              <p className="text-lg text-slate-600">Dr. Shah is a recognized authority in urology, contributing to medical literature and advancing surgical knowledge.</p>
            </div>
                ...
                <Link key={book.slug} href={`/books/${book.slug}`} className="block h-full">
                  <div className="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group h-full flex flex-col cursor-pointer">
                    ...
                    <div className="p-6 flex-1 flex flex-col justify-between">
                      <div>
                        <h3 className="font-heading font-bold text-lg text-slate-900 mb-2 group-hover:text-primary transition-colors">{book.frontmatter.title}</h3>
                        <p className="text-sm text-slate-600 leading-relaxed">{book.frontmatter.description}</p>
                      </div>
                      <div className="mt-4 pt-4 border-t border-slate-100 text-primary font-medium text-sm flex items-center gap-2 group-hover:underline">
                        Read publication <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                      </div>
                    </div>
                  </div>
                </Link>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl mb-16">
          ...
          <p className="text-lg text-slate-600">
            Our clinic is equipped with the latest urological technology in a clean, comfortable, and modern environment.
          </p>
        </div>
      ...
      <section className="py-20 bg-blue-50 border-y border-blue-100">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <ScrollReveal>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-6">Need Immediate Care?</h2>
              <p className="text-lg text-slate-700 mb-8 leading-relaxed">
                Urological emergencies like severe kidney stone pain, urine retention, or blood in urine require prompt attention. We offer 24/7 emergency support to ensure you get the help you need when it matters most.
              </p>
              <div className="flex flex-col gap-4 mt-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold tracking-wider uppercase text-red-600">24/7 Active Emergency Helpline</span>
                </div>
                <a 
            ...
            <ScrollReveal delay={0.1}>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-blue-100 shadow-sm">
                  ...
                  <p className="text-sm text-slate-600">Round-the-clock emergency urological care.</p>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-blue-100 shadow-sm">
                  <ShieldCheck className="w-8 h-8 text-primary mb-4" />
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Expert Team</h3>
                  <p className="text-sm text-slate-600">Led by Gold Medalist Dr. Arun Shah.</p>
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl">
          <ScrollReveal>
            ...
            <p className="text-lg text-slate-600 mb-8">
              Schedule your one-on-one consultation with Gold Medalist Dr. Arun Shah today without any hassle.
            </p>
