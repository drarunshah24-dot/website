...
export async function POST(req: Request) {
  ...
  try {
    ...
    // If running on Cloudflare Pages or GITHUB_TOKEN is set, commit directly to GitHub repository!
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "Filesystem is read-only. Please add GITHUB_TOKEN to your Environment Variables to upload images permanently.",
        },
        { status: 500 },
      );
    }
